...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Sie 2021, 21:19
...
CREATE TABLE `city` (
  ...
  `image_city` varchar(255) DEFAULT NULL,
...
INSERT INTO `city` (`id`, `name`, `description`, `id_voivodship`, `image_city`, `created_at`, `deleted`) VALUES
(1, 'Lublin', 'xDxDxDxD', 3, NULL, '2021-08-21 16:56:51', 0),
(2, 'Lubartów', 'lalala', 3, NULL, '2021-08-21 16:56:51', 0),
(3, 'Rzeszów', '', 9, NULL, '2021-08-21 16:56:51', 0),
(4, 'Kielce', 'Nie dodano opisu miasta', 13, NULL, '2021-08-21 16:56:51', 0),
(5, 'Opatów', 'Nie dodano opisu miasta', 13, NULL, '2021-08-21 16:56:51', 0),
(6, 'Łódź', 'Nie dodano opisu miasta', 5, NULL, '2021-08-21 16:56:51', 0),
(7, 'oh boi', 'asdasd', 16, NULL, '2021-08-25 19:16:13', 1);
...
(1, 4, 'admin', 'Średni', 'dsa', 'amogus.png'),
(3, 9, 'Buffy', 'Duży', 'Fajne doggo', NULL),
(4, 10, 'leszek', 'Duży', 'sdsdsda asd as', 'amogus.png'),
(5, 5, 'Testa', 'Średni', 'Tak, to bardzo fajny pieseł', 'awatar_normal.png');
...
(5, 'Kurwisco', 1, 'Test test test test test test', 1),
(6, 'Kurvisco', 1, 'test test test test', 1),
(7, 'test kurwa', 3, 'kurwa w pizde jebaną', 0);
...
(4, 'tttttttttttttttttttttttttttttt', 5, 4),
(5, 'assssssssssssssss', 5, 4),
(6, 'dodajcie miasto pliska', 5, 3),
(7, 'test elo', 4, 3),
(8, 'rrrrrrrrrrrrrrrrrrrrrr', 5, 3);
...
(4, 'Piotr', 'Czajka', 'p.czajka.1998@gmail.com', 1, 'Jednak dodano', 0, '$2y$10$JkBdQp84T2WG/NdqoLEsr.pV2JnJS0ZFmSP2AfK30VNM8PVnGRntu', 'Rollermix', 0, 0),
(5, 'Piotr', 'Czajka', 'xd@o2.pl', 3, 'xd', 0, '$2y$10$JkBdQp84T2WG/NdqoLEsr.pV2JnJS0ZFmSP2AfK30VNM8PVnGRntu', 'admin', 0, 1),
(6, 'Tomek', 'Atomek', 'tomek@gmail.com', NULL, 'nie wiem', 0, '$2y$10$JkBdQp84T2WG/NdqoLEsr.pV2JnJS0ZFmSP2AfK30VNM8PVnGRntu', 'tomek', 0, 0),
(7, 'Mateusz', 'Kowalski', 'kowal@gmail.com', 4, '', 0, '$2y$10$JkBdQp84T2WG/NdqoLEsr.pV2JnJS0ZFmSP2AfK30VNM8PVnGRntu', 'Kowal', 0, 0),
(8, 'Bożena', 'Czajka', 'boz@gmail.com', NULL, '', 0, '$2y$10$JkBdQp84T2WG/NdqoLEsr.pV2JnJS0ZFmSP2AfK30VNM8PVnGRntu', 'boz', 0, 0),
(9, 'Maciek', 'Tomasz', 'maciek@gmail.com', 1, 'XD', 0, '$2y$10$JkBdQp84T2WG/NdqoLEsr.pV2JnJS0ZFmSP2AfK30VNM8PVnGRntu', 'maciek', 0, 0),
